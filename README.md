...
- 🤖 **AI 智能分析** - 支持 DeepSeek、通义千问、Kimi、OpenAI 等多模型动态配置
- 📅 **任务调度管理** - 可视化定时任务管理与日志查看
...
- **多模型配置**: 支持 DeepSeek, Qwen, Kimi, OpenAI, Gemini 动态切换
- **定时任务**: 可视化 Cron 表达式配置,任务日志实时查看
- **系统日志**: 任务执行状态全链路追踪
- **API Key 管理**: 安全脱敏存储与连接测试
